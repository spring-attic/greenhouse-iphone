...
@interface GHKeychainManager ()

- (NSMutableDictionary *)queryKeychainWithService:(NSString *)service account:(NSString *)account;

@end

@implementation GHKeychainManager

#pragma mark -
#pragma mark Static methods

// Use this class method to obtain the shared instance of the class.
+ (GHKeychainManager *)sharedInstance
{
    static GHKeychainManager *_sharedInstance = nil;
    static dispatch_once_t predicate;
    dispatch_once(&predicate, ^{
        _sharedInstance = [[GHKeychainManager alloc] init];
    });
